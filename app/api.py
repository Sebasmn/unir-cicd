...
@api_application.route("/calc/logarithmbaseten/<op_1>", methods=["GET"])
def logarithmbaseten(op_1):
    try:
        num_1 = util.convert_to_number(op_1)
        return ("{}".format(CALCULATOR.logarithmbaseten(num_1)), http.client.OK, HEADERS)
    except TypeError as e:
        return (str(e), http.client.BAD_REQUEST, HEADERS)